CREATE OR REPLACE FUNCTION public.create_order_with_items(_details jsonb, _items jsonb, _shipping_fee numeric, _upfront_rate numeric, _promo_code text, _instapay_reference text, _payment_proof_path text)
...
BEGIN
  ...
  LOOP
    ...
    v_min_price := v_product_starting_price
