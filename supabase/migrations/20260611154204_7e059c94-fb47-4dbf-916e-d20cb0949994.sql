...
ALTER TABLE public.order_items ADD COLUMN IF NOT EXISTS bed_rails BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE public.order_items ADD COLUMN IF NOT EXISTS bed_rails_price NUMERIC NOT NULL DEFAULT 0;
