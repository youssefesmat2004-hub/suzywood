...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crafting safe, beautiful spaces for your little ones. Solid wood, non-toxic, made to order." },
    ...
    <Layout>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-5 space-y-7">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                ...
                <Button asChild size="lg" variant="outline">
                  <Link to="/custom-builds">Request Custom Build</Link>
                </Button>
              </div>
            </div>
            <div className="lg:col-span-7 relative">
              <div className="relative aspect-[5/6] lg:aspect-[4/5] rounded-3xl overflow-hidden shadow-elegant">
                <img
                  src={hero}
                  alt="Beautifully styled neutral-toned nursery with a handcrafted oak crib"
                  width={1920}
                  height={1280}
      ...
      <section className="container mx-auto px-6 lg:px-10 py-24">
        <div className="flex flex-wrap items-end justify-between gap-6 mb-12">
          ...
          <Link to="/shop" className="text-sm border-b border-primary pb-0.5 hover:opacity-70">
            View all pieces →
          </Link>
        </div>
      ...
      <section className="container mx-auto px-6 lg:px-10 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-card order-2 lg:order-1">
            <img
              src={craft}
              alt="Artisan hands shaping solid oak in the Suzy Wood workshop"
              loading="lazy"
              width={1280}
              height={1280}
              className="h-full w-full object-cover"
          ...
          <div className="space-y-6 order-1 lg:order-2 lg:pl-8">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-balance">
              Bringing warmth and safety to every home with heirloom-quality wood pieces.
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Every Suzy Wood piece is hand-joined from solid timber by a small team of carpenters in Cairo.
              We use plant-based, non-toxic finishes and rounded edges throughout — so the furniture in your
              child's first room is something you'd be proud to keep for the next.
            </p>
