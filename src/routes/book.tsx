...
import { sendGuidanceBookingReceivedEmail } from "@/lib/customer-received-emails.functions";
...
function BookPage() {
  ...
  const sendReceived = useServerFn(sendGuidanceBookingReceivedEmail);
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (parsed.data.customer_email) {
      sendReceived({ data: { bookingId: res.id } }).catch(() => {});
    }
