...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Suzy Wood — Premium Babies & Toddlers Furniture" },
      { name: "twitter:title", content: "Suzy Wood — Premium Babies & Toddlers Furniture" },
      { property: "og:description", content: "Handcrafted nursery and toddler furniture made to order in Cairo." },
      { name: "twitter:description", content: "Handcrafted nursery and toddler furniture made to order in Cairo." },
